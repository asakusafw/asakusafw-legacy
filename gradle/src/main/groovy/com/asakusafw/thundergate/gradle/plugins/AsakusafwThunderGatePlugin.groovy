...
/**
 * A Gradle plug-in for Asakusa ThunderGate facilities.
 * @since 0.8.0
 */
class AsakusafwThunderGatePlugin implements Plugin<Project> {

    /**
     * The plug-in ID.
     */
    public static final String ID = 'asakusafw-thundergate'
